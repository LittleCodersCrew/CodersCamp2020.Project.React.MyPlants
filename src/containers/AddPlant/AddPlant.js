          ...
          <div className={styles.info}>
            ...
            <div className={styles.about}>
              ...
              <div className={styles.details}>
                <p>
                  <span>Species:</span>
                  <span className={styles.italic}>{plant.species}</span>
                </p>
                <p>
                ...
                <p>
                  <span>Sunlight:</span>
                  <span className={styles.italic}>{plant.sunlight}</span>
                </p>
                <p>
                  <span>Humidity:</span>
                  <span className={styles.italic}>{plant.humidity}</span>
                </p>
                <p>
                  <span>Watering:</span>
                  <span className={styles.italic}>{plant.watering}</span>
                </p>
                <p>
                  <span>Watering method:</span>
                  <span className={styles.italic}>{plant.watering_method}</span>
                </p>
                <p>
                  <span>Application:</span>
                  <span className={styles.italic}>{plant.application}</span>
                </p>
                <p>
                  <span>Subsoil: </span>
                  <span className={styles.italic}>{plant.subsoil}</span>
                </p>
                <p>
                  <span>Conditioners: </span>
                  <span className={styles.italic}>{plant.conditioners}</span>
                </p>
                <p>
                  <span>Spraying: </span>
                  <span className={styles.italic}>{plant.spraying}</span>
                </p>
                <p>
                  <span>Toxicity: </span>
                  <span className={styles.italic}>{plant.toxicity?.human ? 'yes' : 'no'}</span>
                </p>
                <p>
                  <span>Safe for domestic animals: </span>
                  <span className={styles.italic}>{plant.toxicity?.animal ? 'no' : 'yes'}</span>
                </p>
              </div>
            </div>
          </div>
